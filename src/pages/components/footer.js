...
const Footer = () => {
  return (
    <footer className=" bg-white shadow rounded-lg md:p-6 xl:p-8">
      <div className="mb-1.5 mt-1.5 md:flex md:items-center md:justify-between">
        ...
        <div className="mb-1.5 mt-1.5 flex justify-center space-x-6">
