export const calculateFieldArea = (geoJson) => {
    try {
        if (!geoJson || !geoJson.geometry || !geoJson.geometry.coordinates || 
            !geoJson.geometry.coordinates[0] || geoJson.geometry.coordinates[0].length < 3) {
...
export const getSoilTypeDescription = (soilType) => {
    const descriptions = {
        ...
        sandy: "Sandy soil is light and drains quickly. It warms up faster in spring but has lower nutrient content and water retention.",
        loam: "Loam is the ideal soil type with balanced properties. It has good structure, drainage, and nutrient content.",
        silty: "Silty soil is fertile with good water retention and drainage. It's easy to work with but can become compacted.",
        peaty: "Peaty soil is dark, high in organic matter and moisture retention. It's typically acidic and warms slowly in spring."
    };
    
    return descriptions[soilType.toLowerCase()] || "No information available for this soil type.";
};
