    ...
    >
      <div style={{ minWidth: "350px" }}>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <div style={{ textAlign: "right" }}>Temperature: {temperature}°C</div>
        </div>
        ...
        {activeTab === "general" && (
          <div>
            ...
            <div style={{ margin: "10px 0" }}>
              <strong>Field Area:</strong> {calculateFieldArea(popup.area)}{" "}
              hectares
            </div>
            ...
            <div>
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    popup.aiRecommendations || "<p>No recommendations yet</p>",
                }}
              />
              <button
